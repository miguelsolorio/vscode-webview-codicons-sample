...
function activate(context) {
    context.subscriptions.push(vscode.commands.registerCommand('catCodicons.show', () => {
...
class CatCodiconsPanel {
    static show(extensionUri) {
        const column = vscode.window.activeTextEditor
            ...
            : undefined;
        const panel = vscode.window.createWebviewPanel(CatCodiconsPanel.viewType, "Webview Chart Colors", column || vscode.ViewColumn.One);
...
CatCodiconsPanel.viewType = 'catCodicons';
